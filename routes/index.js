...
router.get('/shellOperate', function (req, res, next) {
    ...
    switch (doType){
        ...
        case "2"://移动操作
            shell = "mv "+sourcePath+"  "+targetPath;break;
        case "3"://复制操作
            shell = "cp -f -r "+sourcePath+"  "+targetPath;break;
        case "4"://重命名文件
            shell = "mv "+sourcePath+"  "+targetPath;break;
        case "5"://新建文件
            shell = "touch "+targetPath;break;
        case "6"://新建文件夹
            shell = "mkdir "+targetPath;break;
        case "7"://zip解压
            shell = "unzip -o -q "+sourcePath+" -d "+sourcePath.substring(0,sourcePath.length-4);break;
        case "8"://zip压缩
            shell = "zip -q -r "+sourcePath+".zip "+sourcePath;break;
    }
    if(shell.length>0){
